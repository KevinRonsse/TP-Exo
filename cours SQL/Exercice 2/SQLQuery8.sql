...
SELECT * FROM book order by titre asc;

SELECT * FROM book order by date_publication asc;

SELECT TOP 10 date_publication FROM book order by date_publication asc;

SELECT TOP 10 * FROM book order by date_publication asc;

SELECT TOP 10 date_publication, auteur, titre FROM book order by date_publication asc;

SELECT * FROM book where auteur='Agatha Christie';

UPDATE book set auteur='Agatha Christie' where auteur='Agatha Christies';

INSERT INTO book (titre, auteur, editeur, date_publication, isbn_10, isbn_13)
values 
...
DELETE from book where titre = 'Agatha Christie' and auteur='Agatha Christie';
